...
## ksqlDB and optional Flink

Run `./scripts/up-ksqldb.sh` for SQL-style stream processing. Flink is optional and can be started with `docker compose -f compose/flink.yml up -d`.
