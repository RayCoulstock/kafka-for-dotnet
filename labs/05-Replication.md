...
Use `./scripts/up-cluster.sh`. This cluster is separate from the single-broker labs and is intended for instructor demonstrations of replication, ISR, leader election, and broker failure.
